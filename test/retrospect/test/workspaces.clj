...
(defn simple-hyps-fixture [f]
  ...
  (binding [last-id 0]
    (let [s1 (new-hyp "S" :sensor :sensor (constantly []) 1.0 nil [] [] "" {})
          s2 (new-hyp "S" :sensor :sensor (constantly []) 1.0 nil [] [] "" {})
          a (new-hyp "A" :hyp :hyp (constantly []) 0.75 :and [s1 s2] [s1 s2] "" {})
          b (new-hyp "B" :hyp :hyp (constantly []) 0.5  :and [s2] [s2] "" {})
