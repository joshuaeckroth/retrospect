  ...
  {:name "Abduction"
   ...
   (fn []
     (merge {:Threshold [0 [0]]
             :MetaMinScore [0 [0]]
             :MetaThreshold [0 [0]]
             :MetaOracle ["meta-insuf-ev,meta-impl-exp,meta-order-dep,meta-conf-exp"
             ...
             :SimulateSomeMetaHyps [true [true false]]
             :RemoveEssentialConfExp [false [true false]]
             :ScoreMetaConfExp ["opt2" ["opt1" "opt2" "opt3" "opt4" "opt5"]]
             :ScoreMetaImplExp ["opt2" ["opt1" "opt2"]]
             :ScoreMetaInsufEv ["opt2" ["opt1" "opt2"]]
   ...
   :meta-hyp-types #{:meta-insuf-ev :meta-impl-exp :meta-order-dep :meta-conf-exp}
