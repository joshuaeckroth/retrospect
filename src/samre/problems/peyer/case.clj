(ns samre.problems.peyer.case
  (:require [samre hypotheses])
  (:require [samre.strategies core])
  (:require [clojure string])
  (:import [samre.hypotheses HypothesisSpace])
  (:import [samre.strategies StrategyState])
  (:use clojure.set)
  (:use clojure.test)
  (:use samre.strategies)
  (:use samre.hypotheses))
